...
opcion = input('Digite un numero del 1 al 4: ')
...
#no debería aparecer en el nuevo diccionario  
    ...
    n_ciudad2 = input('Coloque el nombre de la ciudad tal y como se muestra en la parte superior: ')
    ...
    if n_ciudad2 == 'Guayaquil':
        ...
        print('No hay planta que otorgue energía en la ciudad que escogio')
    print()
...
#región
    ...
    n_region = input('Coloque el nombre de la Región tal y como se muestra en la parte superior: ')
